/* Класс для управления процессом астрометрии:
   - приём информации с разных каналов
     (список экранных звёзд [Detector],
      список каталожных звёзд [StarcatScreen],
      список целей [Strob],
      вектор сосотояния телескопа [Telescope]);
   - синхронизация информации с разных каналов (с помощью QQueue);
   - отождествление звёздных конфигураций (модуль astrometry);
   - вычисление коэффициентов линейного преобразования
     от картинной плоскости в плоскость каталога (класс LinCor);
   - преобразование координат целей из экранной плоскости
     в плоскость каталога.
*/
#ifndef ANGMETER_H
#define ANGMETER_H
/////////////////////////////////////////////////////////////////////////////////////
